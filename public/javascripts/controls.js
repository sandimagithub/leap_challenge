(function() {
  window.recorder.controller('Controls', [
    '$scope', '$location', '$document', '$analytics', function($scope, $location, $document, $analytics, $http) {
      var track;
      ...
      $scope.save = function(format) {
        ...
        // Begin modifying existing code example to 
        //  integrate with RAILS Backend

        // Change Logic to send a
        //  POST /recording with body: player().recording
        //    $.post 
        console.log("SHYTE!!");
...
//                DELETE /recordings/:id(.:format)      recordings#destroy
//
//
//    --------------------------\
//    |                         |
...
//        ||  
//        ||                      makes a GET request for     4. responds with
//        ||                                                     public/controls.js file
//       \||/                     public/control.js
//    ----------------------------\            ||             ||
//    |                           |            ||             ||
//    |           Browser         |            ||             ||
